...
//시간표 시간
Setting.setClassStartTime(ClassName.CLASS1, 8, 0)
Setting.setClassStartTime(ClassName.CLASS2, 9, 20)
Setting.setClassStartTime(ClassName.CLASS3, 10, 20)
Setting.setClassStartTime(ClassName.CLASS4, 11, 20)
Setting.setClassStartTime(ClassName.LUNCH, 12, 20)
Setting.setClassStartTime(ClassName.CLASS5, 14, 0)
Setting.setClassStartTime(ClassName.CLASS6, 15, 0)
Setting.setClassStartTime(ClassName.CLASS7, 16, 0)
//시간표 과목
